...
import type { User, Gender, Orientation } from '@/feature/user/entity';
import { service as database_svc } from '@/core/database/service';
import { GENDERS, ORIENTATIONS } from '@/feature/user/entity';
		...
		if (typeof value === 'string') {
			...
			switch (key) {
				...
				case 'fame_max':
					...
					break;
				case 'gender':
					filters.type = { ...filters.type, gender: value };
					break;
				case 'orientation':
					filters.type = { ...filters.type, orientation: value };
					break;
				case 'page':
