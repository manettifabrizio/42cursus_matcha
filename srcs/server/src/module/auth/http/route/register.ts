...
import { action as createAccount }   from '@/module/auth/use-case/create/action';
import { action as createUser }      from '@/module/user/use-case/create/action';
...
export const route: RequestHandler<{}, ResponseBody> = async (req, res) =>
{
	try
	{
		...
		const account = await createAccount(validation_svc, database_svc, crypto_svc,
		{
